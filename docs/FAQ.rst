...
* Is it possible to have a better comment system, with reply feature for
  example ?
...
* I want an image gallery in my posts, what can I do ?
    ...
    ForeignKey to the Entry model. Then in the admin module of your app,
    unregister the EntryAdmin class, and use ModelInline in your new admin
    class.
