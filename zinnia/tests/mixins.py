...
class MixinTestCase(TestCase):
    ...
    def test_previous_next_published_mixin(self):
        ...
        self.assertEqual(epnp.get_next_week(test_date), date(2012, 1, 1))
        ...
        self.assertEqual(epnp.get_next_week(test_date), date(2012, 3, 15))
        ...
        epnp = EntryPreviousNextPublished()
        self.assertEqual(epnp.get_previous_year(test_date), None)
        self.assertEqual(epnp.get_previous_week(test_date), date(2012, 1, 1))
        ...
        self.assertEqual(epnp.get_next_year(test_date), date(2013, 1, 1))
        self.assertEqual(epnp.get_next_week(test_date), date(2013, 6, 2))
        ...
        self.assertEqual(epnp.get_previous_week(test_date), date(2012, 3, 15))
        ...
        self.assertEqual(epnp.get_previous_week(test_date), date(2013, 6, 2))
