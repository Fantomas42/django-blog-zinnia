    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', mptt.fields.TreeForeignKey(related_name=b'children', verbose_name='parent category', blank=True, to='zinnia.Category', null=True)),
            ],
            options={
                'ordering': ['title'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(help_text='Used for illustration.', upload_to=b'uploads/zinnia', verbose_name='image', blank=True)),
                ...
                ('categories', models.ManyToManyField(related_name=b'entries', null=True, verbose_name='categories', to='zinnia.Category', blank=True)),
                ...
                ('sites', models.ManyToManyField(help_text='Sites where the entry will be published.', related_name=b'entries', verbose_name='sites', to='sites.Site')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='entry',
            name='authors',
            field=models.ManyToManyField(related_name=b'entries', verbose_name='authors', to='zinnia.Author', blank=True),
